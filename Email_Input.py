...
import random
import numpy as np
from collections import Counter   # Counter is a sict subclass. It is an unordered collection where elements are
								  # stored as keys, and their counts as dict values.

class DocReader():
    def __init__(self):
        pass

    # Returns the int type cast of a string, if it is a digit.
    def atoi(self, text):
	   return int(text) if text.isdigit() else text

	# Returns the splitted regular expression, and converts string to int. 
	# \d+ stands for matching [0-9].
